  ...
  return (
    <Layout>
      <div className="my-3 flex flex-col gap-4">
        <div className="w-full bg-gray-300 h-60 my-4 rounded-lg animate-pulse duration-150" />

        <div className="grid grid-cols-4 gap-4">
          <div className="w-full bg-gray-300 h-32 rounded-lg animate-pulse duration-150"></div>
          <div className="w-full bg-gray-300 h-32 rounded-lg animate-pulse duration-150"></div>
          <div className="w-full bg-gray-300 h-32 rounded-lg animate-pulse duration-150"></div>
          <div className="w-full bg-gray-300 h-32 rounded-lg animate-pulse duration-150"></div>
        </div>
